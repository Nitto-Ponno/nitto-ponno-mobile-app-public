...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        primary: "var(--color-primary)", //Light Theme: primary: "#00a303",  Dark Theme: primary: "#00a303",
        secondary: "var(--color-secondary)", //Light Theme: secondary: "#f0e800",  Dark Theme: secondary: "#f0e800",
        background: "var(--color-background)", //Light Theme: background: "#fcfcfc",  Dark Theme: background: "#fcfcfc",
        foreground: "var(--color-foreground)", //Light Theme: foreground: "#ededed",  Dark Theme: foreground: "#ededed",
        heading: "var(--color-heading)", //Light Theme: heading: "#252525",  Dark Theme: heading: "#252525",
        body: "var(--color-body)", //Light Theme: body: "#8E8E8E",  Dark Theme: body: "#8E8E8E",
        line: "var(--color-line)", //Light Theme: line: "#ECECEC",  Dark Theme: line: "#ECECEC",
        border: "var(--color-border)", //Light Theme: border: "#E7E7E7",  Dark Theme: border: "#E7E7E7",
        success: "var(--color-success)", //Light Theme: success: "#17b723",  Dark Theme: success: "#17b723",
        warning: "var(--color-warning)", //Light Theme: warning: "#F59E0B",  Dark Theme: warning: "#F59E0B",
        error: "var(--color-error)", //Light Theme: error: "#db2500",  Dark Theme: error: "#db2500",
      },
    },
  },
  plugins: [],
