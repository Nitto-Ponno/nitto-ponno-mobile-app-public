...
import { View, Image, StyleSheet, ViewStyle, FlatList, NativeScrollEvent, NativeSyntheticEvent } from "react-native";

import { Colors } from "../../context/ThemeProvider";
import { screenWidth } from "../../utils/Sizes";
import { TSlide } from "@/services/types/productTypes";
...
const s: TSlide[] = [
  {
    ...
    order: 1,
    linkType: "external",
    linkUrl: "https://www.freepik.com/free-vector/abstract-technology-banner-background_4120175.htm",
